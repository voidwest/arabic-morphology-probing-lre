...
| BF16/Q8 metric-direction agreement 105/108 | `evidence/bf16-analysis-20260826-v2/snapshot/analysis/results/bf16_q8_comparison.json` | count `above_majority_sign_agrees` over overlapping fold-0 comparisons |
| Direct BF16/Q8 vector comparison unavailable | `evidence/bf16-analysis-20260826-v2/snapshot/analysis/results/bf16_q8_comparison.json`, `evidence/bf16-analysis-20260826-v2/snapshot/analysis/results/local_analysis_sufficiency.json` | `vector_comparison=not_recomputed` |
